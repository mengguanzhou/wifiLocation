...
public class APListAdapter extends BaseAdapter{
    ...
    public APListAdapter(Context context, ArrayList<AccessPoint> datas){
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.rssi.setText(mDatas.get(position).getRssi() + "");
        holder.times.setText(mDatas.get(position).getOrder() + "");
